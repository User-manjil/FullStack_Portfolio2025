  ...
  return (
    <div
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${
        scroll ? "bg-black/60 backdrop-blur-md shadow-lg" : "bg-transparent"
      }`}
    >
      <div className="max-w-6xl mx-auto py-4 px-5 flex justify-between items-center">
        ...
        <Link to="/contact" className="hidden sm:flex">
          <div
            className="border px-4 py-2 border-[var(--muted)]
            font-[Bricolage Grotesque] text-[10px] rounded-[var(--r)]
            text-[var(--text)] hover:bg-[var(--lime)] hover:text-black
      ...
      <div
        className={`
          sm:hidden flex flex-col bg-black/95 backdrop-blur-xl
      ...
      >
        ...
        <div className="px-6 mt-6">
          <Link to="/contact" onClick={closeMenu}>
            <div
              className="border px-4 py-3 border-[var(--muted)]
              font-[Bricolage Grotesque] text-[12px]
              rounded-[var(--r)] text-[var(--text)]
              hover:bg-[var(--lime)] hover:text-black
